  ...
  <script>
    ...
    function renderItemSet(itemSet) {
      ...
      for (const [slotName, item] of Object.entries(itemSet.items)) {
        if (slotName.startsWith('Flask') || slotName.startsWith('Charm')) {
  ...
  const sections = [];
    ...
    function getSlotIcon(slotName) {
      const icons = {
        ...
        'Charm': '<svg width="14" height="14" viewBox="0 0 24 24" fill="white"><circle cx="12" cy="12" r="9" opacity="0.3"/><path d="M12 2L13.5 8.5L20 10L13.5 11.5L12 18L10.5 11.5L4 10L10.5 8.5L12 2Z"/><circle cx="12" cy="12" r="3"/></svg>',
