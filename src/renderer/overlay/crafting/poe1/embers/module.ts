...
export function render(list: EmberItem[]): void {
  ...
  panel.innerHTML = `
    ...
    <div id='emberTagFiltersRow' style='display:flex; justify-content:center; width:100%;'>
      <div id='emberTagFilters' style='display:inline-flex; flex-wrap:wrap; gap:4px; margin-bottom:4px;'></div>
    </div>
