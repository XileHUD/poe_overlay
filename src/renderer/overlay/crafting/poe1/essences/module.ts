...
export function render(list: EssenceItem[]): void {
  ...
  panel.innerHTML = `
    ...
    <div id='essenceTagFiltersRow' style='display:flex; justify-content:center; width:100%;'>
      <div id='essenceTagFilters' style='display:inline-flex; flex-wrap:wrap; gap:4px; margin-bottom:4px;'></div>
    </div>
